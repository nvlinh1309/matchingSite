        ...
        <div id="container" class="w-clear">
            <div id="col_920" class="col_920_right">
                <div class="form-container" data-reactid="42">
                    <!-- react-empty: 43 -->
                    <div class="form-title col-lg-12 col-md-12 col-xs-12">FORGOT PASSWORD</div>
                    ...
                    @endif
                    <form action="{{route('postForgot_pass')}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="col-lg-12 col-md-12 col-xs-12" style="padding: 0px">
                                <button type="submit" class="btn btn-login" id="btn-login" style="">Send Password Reset Link</button>
                            </div>
                        </div>
                    </form>
                    <!-- react-empty: 64 -->
